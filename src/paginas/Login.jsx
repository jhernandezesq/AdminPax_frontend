  ...
  return (
    <section className="min-h-screen flex items-stretch text-white ">
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" /* style="background-color: #161616;" */>
            <div className="bg-fondo-pax absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" /* style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);" */>
                <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
            <div className="w-full py-6 z-20">
                ...
                <form className="mx-10" onSubmit={handleSubmit}>
                    ...
                    <div className="bg-white flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                      ...
                      <input className="pl-2 outline-none border-none text-gray-500" type="text" name="" id="" placeholder="Ingresa tu correo" value={email}
          onChange={e => setEmail(e.target.value)} />
                    </div>
                    <div className="bg-white flex items-center border-2 py-2 px-3 rounded-2xl mb-5">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                      </svg>
                      <input className="pl-2 outline-none border-none text-gray-500" type="password"  id="password" placeholder="contraseña" value={password}
          onChange={e => setPassword(e.target.value)} />
                    </div>
                    <input type="submit" value="Iniciar Sesion" className='bg-sky-700 mb-5 w-full py-3 text-white font-bold rounded hover:cursos-pointer hover:bg-sky-800 transition-colors' />
