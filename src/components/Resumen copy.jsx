...
const Resumen = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 place-items-center   items-center justify-center bg-gray-200">
      <div className="bg-white p-8 w-[22rem] md:w-[70rem]">
        <div className=" flex flex-col">
          ...
          <h2 className="font-bold text-3xl mt-5 text-right">
            ...
            <table className="min-w-full divide-y divide-slate-500 ">
              <thead>
                <tr>
                  ...
                  <th
                    scope="col"
                    className="py-3.5 px-5 text-center text-sm font-normal text-slate-700 "
                  >
                    DIRECCION
                  </th>
                  <th
